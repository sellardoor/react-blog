...
const CommentsComp = props => {
  useEffect(() => {
    props.toogleSpin(true);
    props.initMessage({ type: props.location.query._id }).then(() => {
      props.toogleSpin(false);
    });
  }, []);
...
const mapDispatchFromProps = {
  initMessage: payload => ({ type: 'article/initMessage', payload }),
  submitMessage: payload => ({ type: 'article/submitMessage', payload }),
